...
public class DetailFragment extends Fragment implements View.OnClickListener{
    ...
    public DetailFragment(NMapActivityPresenter parentPresenter){
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transportAdapter = new TransportAdapter(parentPresenter.getTransportData(), parentPresenter.getPersonList());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenter.initData(parentPresenter.getPersonList(), parentPresenter.getTransportData());
